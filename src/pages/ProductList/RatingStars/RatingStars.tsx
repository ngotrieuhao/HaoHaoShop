...
const RatingStars = ({ queryConfig }: Props) => {
  ...
  const { t } = useTranslation('ratingstar')
                      ...
                      <svg viewBox='0 0 9.5 8' className='mr-1 h-4 w-4' key={indexStar}>
                        <defs>
                          <linearGradient id='ratingStarGradient' x1='50%' x2='50%' y1='0%' y2='100%'>
                            ...
                            <stop offset={1} stopColor='#ffeb0b' />
                          </linearGradient>
                          <polygon
                            id='ratingStar'
                        ...
                        <g fill='#ffeb0b' fillRule='evenodd' stroke='none' strokeWidth={1}>
                    ...
                    <svg viewBox='0 0 30 30' className='mr-1 h-4 w-4' key={indexStar}>
                      <defs>
                        <linearGradient id='star__hollow' x1='50%' x2='50%' y1='0%' y2='99.0177926%'>
                          <stop offset='0%' stopColor='#b5b4b4' />
                          <stop offset='100%' stopColor='#b5b4b4' />
                        </linearGradient>
                      </defs>
                      <path
                        fill='none'
